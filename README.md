...
A lightweight, fully client-side web application for taking and managing your notes. Built with simplicity, speed, and absolute privacy in mind.

## 🚀 Features

- **Split-pane Interface**: Easily navigate between your note list and the editor.
- **Resizable Sidebar**: Drag the divider to adjust the sidebar width to your preference.
- **Theme Support**: Includes both Dark and Light modes for a comfortable writing experience in any environment.
- **Instant Save**: Notes are saved immediately as you type.
- **Zero Dependencies**: Pure HTML, CSS, and JavaScript. No bulky frameworks or build steps needed.
